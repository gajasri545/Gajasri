...
dataset_text = "/users/gajasri.E/Desktop/miniproject1/Flickr8k_text"
dataset_images = "/users/gajasri.E/Desktop/miniproject1/Flicker8k_Dataset"
...
def define_bilstm_model(vocab_size, max_length):
    # Feature extractor from CNN (Image features)
    inputs1 = Input(shape=(2048,), name='input_1')
    fe1 = Dropout(0.5)(inputs1)
    fe2 = Dense(256, activation='relu')(fe1)  # Keep CNN features at 256

    # BiLSTM sequence model
    inputs2 = Input(shape=(max_length,), name='input_2')
    se1 = Embedding(vocab_size, 256, mask_zero=True)(inputs2)
    se2 = Dropout(0.5)(se1)
    se3 = Bidirectional(LSTM(128))(se2)  # Set LSTM units to 128 so total output = 256

    # Merging both models
    decoder1 = add([fe2, se3])  # Now both have shape (256,)
...
model = define_bilstm_model(vocab_size, max_length)
epochs = 10
